EPD_values <- seq(from = 4.5, to = 6.5, length.out =  2)
cooling_eff_values <- seq(from = 4, to = 4, length.out =  1)
heating_eff_values <- seq(from = 4, to = 4, length.out =  1)
...
infiltration_values <- floor(seq(from = 2, to = 4, length.out =  2))
...
cooling_values <- (seq(from = 28, to = 38, length.out =  11))
heating_values <- (seq(from = 39, to = 40, length.out =  2))
...
parametric_file <- c(
  ...
  str_c("Parametric:SetValueForRun,$cooling,", str_c(values$cooling, collapse = ","),";"),
  str_c("Parametric:SetValueForRun,$heating,", str_c(values$heating, collapse = ","),";")
)
