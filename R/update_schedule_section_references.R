...
update_schedule_section_references <- function(building_subcategory){
  ...
  # file[target_lines] <- str_c("=../../schedules/$schedule,  !- Name of File")
  ...
  # file[target_lines] <- str_c("../../schedules/", building_subcategory_schedule, ".csv, !- Name of File")
  # file[target_lines] <- str_c("L:/EnergyPlus/schedules_res/", building_subcategory_schedule, ".csv, !- Name of File")
  file[target_lines] <- str_c(EP_schedule_path, building_subcategory_schedule, ".csv, !- Name of File")
